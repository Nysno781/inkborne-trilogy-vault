# Book 1 — Working Act Map ("The Gutter & The Sea-Cave")

> **Status:** SKETCH DRAFT — built from locked compass decisions. Not canon. Each act lists its beats + the open questions to resolve as we go.
> **Shape:** ~90–100k words / ~30 chapters / single POV (Adira).
> **Title arc (canon):** Book 1 = *The Gutter & The Sea-Cave* — Survival & Smuggler Arc. Antagonists: Duke Thalor + Inquisitor Crane (regional). Core milestone: Kyrell & Adira outwit Thalor & Crane and are forced toward the High Citadel (Book 2 hook).
> **Settings sweep (canon):** Thalor Coastline → Port Morwen → up the River Aethel → Veridia Tier 3 (The Sinks) → back to the coast for the raid.

---

## ACT I — THE SHORE (Ch 1–5, ~15%)
*Function: strand her. Strip every role. Let the reader fall in love with the world before it breaks.*

- **Ch1 — Departure morning.** The ordinary world, warm and whole: the betrothal voyage, the crew, Adira as Master Wayfinder in her element, Ronan's teasing, the handmaiden beside her. Then the storm hits — chaos, terror, loss. (Cold truth: she loses her ship while doing the thing she's best at.)
- **Ch2 — Wake on sand (late afternoon).** Ronan already pulling the handmaiden from the waterline. The count: five guards gone. Scramble above the tide line. **First night blind** in a sea-cave — no fire, no horizon. Adira feels the *wrongness* of the water through her spine and says nothing.
- **Ch3 — Day 1: the rite.** The guard-captain's body washes in at dawn. Improvised **ocean entombment at sunset** — torn sailcloth, mainland stones, no known channel. The first cultural wrongness, felt by all three.
- **Ch4 — The Wrongness Catalogue (Day 2–4).** Ronan finds no reef, wrong fish, wrong wood. The handmaiden finds wrong tools, a shard of pottery. Adira climbs the ridge and her **map of the world fails** — land to every horizon. She still won't say the worst aloud.
- **Ch5 — People.** From cover: tattooed strangers, alien dress, understandable speech — and one word that chills them: *"ink."* **"We are not alone under the sun."** Economy is alien (no coins). Fear wins: they want home. Ronan worsens (fever/wound). Plan: steal a boat and provisions from what looks like a fat merchant's waterfront staging house.

### 🔓 Open in Act I
- Handmaiden's name/identity/backstory (needed before drafting).
- Whether the guard-captain gets a name + who he was to the handmaiden.
- How visibly Adira's private dread (sea won't take them back) leaks to the others.

---

## ACT II — THE DEBT (Ch 6–13)
*Function: capture them; establish the debt-engine; begin the slow burn inside forced proximity.*

- **Ch6 — The theft & the escape.** One desperate night. Clean execution, boat + stores + medicines. One of Kyrell's men injured. **Adira's locket cord snaps — dropped in the chaos.** They run for open sea…
- **Ch7 — The sea refuses.** Adira reads the current: they *cannot* cross back. The way home is closed. They abandon the identifiable boat and flee inland — into the land that isn't hers.
- **Ch8 — The pursuit.** Kyrell's empire tightens the net (dockmasters, paid eyes, smugglers). The fugitives slip it **once** — small victory, reader breathes. Ronan fading. Second slip. Third report — the Shadow Sovereign has been made a fool on his own coast.
- **Ch9 — Capture & the confrontation (end of pursuit).** Brought before him for the first time. The spectacle: he publicly withholds punishment — turns their crime into *proof* of his control. He claims them as **debt, unspecified**. His injured man wants blood; Kyrell overrules; she watches the room obey. She speaks first — offers herself for the others. First surprise: the leader is the bare-skinned girl. First *seed*: something in her reading of him makes him go still.
- **Ch10 — The terms.** Not prisoners — debtors, put to work at the lowest rung. Ronan to labor/guard (his spear-arm). The handmaiden to a safe, soft post. Adira kept **near him** — he is still solving her. She tells herself it's temporary. Within a day she realizes the **locket is gone** — grief + terror (only she knows what's inside) — but the chaos buries it. She cannot act.
- **Ch11 — Track B ignites.** (Private, invisible to her.) The assay returns: the ink matches **neither** the Weeping Deep nor the Private Northern Seep. A **third source of Prime Ink exists** — and the girl who wore it is the only lead. His interest sharpens from debtors to *asset*. She only feels him grow more attentive.
- **Ch12 — The first task.** He gives her work only she can do — unmarked, so invisible to the Inquisition's ink-sense; foreign, so no one reads her face. A courier run? A waterfront errand that puts her in the path of Crane's patrols? She survives it on wit alone. He watches. (First glimmer of mutual competence.)
- **Ch13 — The road.** He takes his household (and his new debtors) up the River Aethel toward Veridia — his true seat. Journey = forced proximity without romance-pressure: deck work, shared silences, her first real glimpses of the man behind the gloves (how his men obey, how he handles a wounded smuggler). She begins to *wonder* why he keeps her.

### 🔓 Open in Act II
- The exact first task (see also Act III options below).
- How the confrontation's "seed" moment is phrased (the single beat where she reads him and he notices).
- Whether Ronan & the handmaiden get POV-less but *felt* threads here (they are off-screen but alive — the reader must keep loving them).

---

## ACT III — THE GUTTER (Ch 14–22)
*Function: deepen the bond in his world; let Crane/Thalor pressure escalate; plant the raid.*
...
### 🔓 Open in Act III
- Midpoint reversal: which candidate (or a blend)?
- The fracture: park the locket reveal for later, or let her find it here? (Compass lean: hints only in Book 1 — but a late fracture is powerful; decide consciously.)
- Whether Kyrell ever says aloud why he keeps her (lean: no — restraint keeps the tension).

---

## ACT IV — THE SEA-CAVE & THE RAID (Ch 23–30)
*Function: pay off Book 1's regional threat; land the romance's first true crest; torque the series hook.*
...
## Conflict architecture (Level 1) — external conflicts & how they're solved
> Principle: every conflict has a specific, winnable/losable stake and is resolved by the protagonists **acting** — not luck, not villain self-destruction.

- **C1 — Surviving a world that "shouldn't exist" (Act I).** Adira's identity = "I know the sea"; the sea strands her outside her Song. The real fight is her knowledge being useless → she must adapt, not fight. **Solved by:** learning the land like the sea (read, add to the Song), with Ronan (muscle) + handmaiden (heart). **Cost:** loss of certainty.
...
- **Internal — Adira:** refuse the label ("only as valuable as the role I fill") by *acting*: revealing wayfinding to save him, choosing him freely at the crest.
- **Internal — Kyrell:** "power is the only armor; being seen destroys me" → cracked by her reading him → broken at the crest (he'd burn himself; she pulls him back and he lets her in). Shown only through action (single POV).
...
5. What happens to Crane at the end of Book 1 (survives into Book 2 under Vance, or undone)?
6. When the armada is exposed / Vance seizes it — does Vance learn its *true purpose* (the isles / Mountain Blood), or only that it's an illegal navy? (Sets the Book 2 engine.)
